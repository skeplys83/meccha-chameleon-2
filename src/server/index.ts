...
// Two levels up, not three: this file is `src/server/index.ts`. It is only
// read in production, so a wrong depth here survives every dev run and every
// test and fails on the first container start.
